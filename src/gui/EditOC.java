...
public class EditOC extends javax.swing.JFrame {
    
    Case c = new Case("", "", "", "", "", "");
    DataEntriyUser d = new DataEntriyUser("", "", "", "", "");
    List <DataEntriyUser> users;
    public EditOC(String Cname) throws Exception{
        initComponents(); 
        ...
        c = c.ComeCaseInfo(Cname);
         ...
         jLabel1.setText("The User Who Made It is: "+c.User);
    }
    ...
    private void initComponents() {
        ...
        jLabel9.setBounds(110, 700, 80, 30);
        ...
        jLabel10.setBounds(110, 790, 80, 30);
        getContentPane().add(jTextField5);
        jTextField5.setBounds(260, 800, 390, 26);
        getContentPane().add(jLabel1);
        jLabel1.setBounds(670, 750, 330, 0);
      ...
      else
      {
        ...
        c.Source=jTextField5.getText();
          try {
              ...
              Logger.getLogger(EditOC.class.getName()).log(Level.SEVERE, null, ex);
          }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditOC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
