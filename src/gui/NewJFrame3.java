...
public class NewJFrame3 extends javax.swing.JFrame {
    ...
    Case c = new Case("", "", "", "","","");
    public NewJFrame3() throws Exception {
        initComponents();
        setSize(1300, 850);
        setLocation(150,15);
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jComboBox1.setBounds(570, 220, 290, 40);
        ...
        jButton1.setBounds(1110, 740, 140, 60);
        ...
        jButton2.setBounds(1100, 30, 150, 60);
        ...
        jScrollPane1.setBounds(490, 360, 370, 200);

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel3.setText("         Action ID:");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(240, 310, 190, 29);

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel4.setText("Action Date:");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(270, 620, 190, 30);

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel6.setText("Action Time:");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(260, 670, 160, 30);
        getContentPane().add(jTextField3);
        jTextField3.setBounds(490, 670, 360, 26);
        getContentPane().add(jTextField2);
        jTextField2.setBounds(490, 620, 360, 26);
        ...
        jComboBox2.setBounds(490, 310, 370, 26);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTextArea1.getText() == "")
            JOptionPane.showMessageDialog(this, "The Filed is Empty");
        else
        {
            try {
                c.EditAction(jComboBox1.getSelectedItem().toString(), jTextArea1.getText().toString(),jComboBox2.getSelectedItem().toString(),jTextField2.getText(),jTextField3.getText());
            } catch (Exception ex) {
